...
const data = {
  skils: [{ name: "Design" }, { name: "Development" }, { name: "Marketing" }],
  smallText: "I can help your business to",
  largeText: "Get online and grow fast",
  image: {
    title: "this is title",
    url: "https://img.chelseafc.com/image/upload/f_auto,h_860,q_50/editorial/people/first-team/2023-24/Robert_Sanchez_profile_23-24_with_sponsor_avatar-removebg.png",
  },
};
</script>
          ...
          <div class="text-center text-xxl-start">
            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
              ...
              <div class="text-uppercase">
                <span v-for="(skil, index) in data.skils" :key="index">
                  {{ skil.name }}
                  <span v-if="index < skils.length - 1"> &middot; </span>
                </span>
                <!-- <span>Design &middot;</span>
                  <span> Development &middot;</span>
                  <span> Marketing</span> -->
              </div>
            </div>
            ...
            <h1 class="display-3 fw-bolder mb-5">
              <span class="text-gradient d-inline">{{ data.largeText }}</span>
            </h1>
            <div
        ...
        <div class="col-xxl-7">
          ...
          <div class="d-flex justify-content-center mt-5 mt-xxl-0">
            <div class="profile bg-gradient-primary-to-secondary">
              ...
              template/assets/profile.png -->
              <img class="profile-img" :src="data.image.url" :alt="data.image.title" />
              <div class="dots-1">
                <!-- SVG Dots-->
                <svg
                  version="1.1"
